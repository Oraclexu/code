...
class Generator(nn.Module):
    def __init__(self, in_channels=3, out_channels=3):
        ...
        #11
        # self.cn1 =  nn.Conv2d(6, 6, kernel_size=7, stride=1, padding=1)
        # self.cn2 = nn.Conv2d(6, 1, kernel_size=7, stride=1, padding=0)
        #9
        ...
        #5
        self.cn1 =  nn.Conv2d(6, 6, kernel_size=5, stride=1, padding=1)
        self.cn2 = nn.Conv2d(6, 1, kernel_size=3, stride=1, padding=0)
        #3
        #self.cn1 =  nn.Conv2d(6, 6, kernel_size=3, stride=1, padding=1)
        #self.cn2 = nn.Conv2d(6, 1, kernel_size=3, stride=1, padding=0)
